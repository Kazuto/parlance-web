    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div class="mb-8">
        <div class="flex items-center justify-between">
          <div>
            <h1 class="text-3xl font-bold text-gray-900">Entries</h1>
      ...
      <div v-if="isLoading" class="flex items-center justify-center py-12">
        <div class="text-gray-600">Loading entries...</div>
      </div>
      ...
      <div v-else-if="data?.entries" class="bg-white rounded-lg shadow">
        <div class="px-6 py-4">
          <CoreButton
        ...
        <!-- Empty State -->
        <div v-if="data?.entries.length === 0" class="px-6 py-12 text-center">
          <svg
